...
struct Token {
  ...
  struct _capnpPrivate {
    ...
    static constexpr uint16_t dataWordSize = 3;
    static constexpr uint16_t pointerCount = 1;
  };
};
...
struct Statement {
  ...
  struct _capnpPrivate {
    struct IsStruct;
    static constexpr ::capnp::Kind kind = ::capnp::Kind::STRUCT;
    static constexpr uint16_t dataWordSize = 2;
    static constexpr uint16_t pointerCount = 3;
  };
};
...
struct LexedStatements {
  ...
  struct _capnpPrivate {
    struct IsStruct;
    static constexpr ::capnp::Kind kind = ::capnp::Kind::STRUCT;
    static constexpr uint16_t dataWordSize = 0;
    static constexpr uint16_t pointerCount = 1;
  };
};
